...
class Cube(onedspec.Spectrum):
    ...
    def __init__(self, fname: str = None, scidata: Union[str, int] = 'SCI', variance: Union[str, int] = None,
        ...
        """
        super().__init__(fname, scidata, variance, flags, stellar, primary, redshift, wcs_axis, wavelength)
    ...
    def spatial_mask(self, value: Union[np.ndarray, str]):
        if isinstance(value, str):
            if ',' in value:
                ...
                ext_version = None
            self._spatial_mask = fits.getdata(self.fitsfile, ext_name,
                                              ext_version).astype('bool')
